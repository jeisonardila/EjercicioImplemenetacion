...
//SERIES
const serie1 = new Serie("https://url-imagen-1.com", "Breaking Waves", "Drama intenso que sigue las vidas de pescadores en una pequeña ciudad costera.");
const serie2 = new Serie("https://url-imagen-2.com", "Galactic Explorers", "Aventuras intergalácticas de un grupo de exploradores espaciales que descubren mundos asombrosos.");
const serie3 = new Serie("https://url-imagen-3.com", "City of Shadows", "Misterio y suspenso en la oscura metrópolis mientras un detective lucha contra el crimen.");
...
const serie4 = new Serie("https://url-imagen-3.com", "Secretos de la Ciudad a Medianoche", "Una oscura metrópolis envuelta en misterio y suspenso, donde un detective determinado lucha contra el crimen.");
